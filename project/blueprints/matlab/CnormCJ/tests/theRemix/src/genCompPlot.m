%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%
    %%                                                                                                                         %%
        ...
        %% 'ipp' - 'Include Previous p' - If a vector, adds vMax from last p to pool of candidates.                        %%
        %%      0 - Do not consider
        %%      1 - Do consider in the sMax matrix
        %%      2 - Do condider on its own in a test case
    %%                                                                                                                         %%
%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%% %%
function genCompPlot(N, dp, pMax, sMax, type, gp, pq, rv, dr, ipp)
    %% Test Matricies (type)
    ...
    if pq == 'g'
        ...
        if(ipp == 2)
            norms2 = zeros(sizeP, 1);
        end
        if ipp >= 1
            vMax = zeros(length(cMatrix(1,:)),sizeP);
        end
    ...
    for j = 1:sizeP    
        ...
        elseif pq == 'q'
           ...
           elseif ipp == 1
               ...
               fprintf('1\n');
               if j== 1
                   [norms2(j), vMax(:,j)] = genComparison(cMatrix, p(j), .000000001, sMax, 0);
               else
